                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className={`${isRTL ? 'text-right' : 'text-left'} py-3 px-4`}><SortableHeader sortKey="added_to_bill" config={orderSortConfig} setConfig={setOrderSortConfig}>Bill/CCC (added_to_bill)</SortableHeader></th>
