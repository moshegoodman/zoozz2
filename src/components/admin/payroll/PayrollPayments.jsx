...
import { sendPaymentConfirmationEmails } from "@/lib/sendPaymentEmails";
...
export default function PayrollPayments({ users, selectedSeason = "" }) {
  ...
  const handleSave = async () => {
    ...
    // Send confirmation emails (employee + logger)
    await sendPaymentConfirmationEmails({
      employee: users.find(u => u.id === form.employee_user_id),
      amount: form.amount,
