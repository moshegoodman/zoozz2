...
export default function StaffManagement() {
  ...
  return (
    <Card dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      {/* Pay Staff Dialog */}
      <Dialog open={!!payingStaff} onOpenChange={(open) => { if (!open) setPayingStaff(null); }}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Pay {payingStaff?.full_name || payingStaff?.email}</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSubmitPayment} className="space-y-4 py-2">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={() => setPayingStaff(null)}>Cancel</Button>
