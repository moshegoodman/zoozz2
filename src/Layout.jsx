...
import { clearAllEntityCaches } from "@/lib/entityCache";
...
function AppLayout({ children, currentPageName }) {
  ...
  const handleLogout = async () => {
    ...
    // Clear cached entity data (IndexedDB + sync timestamps) so it doesn't leak to the next user.
    try { await clearAllEntityCaches(); } catch (e) { /* best-effort */ }
  ...
  return (
    <div className="min-h-screen bg-gray-50" translate="no" {...bindPullToRefresh()}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link to={createPageUrl("Cart")} className="relative">
                  <Button id="navbar-cart-button" variant="ghost" size="icon">
      ...
      {/* Footer */}
      <footer className="hidden md:block bg-white dark:bg-slate-800 border-t dark:border-gray-700 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-white dark:bg-slate-800">
